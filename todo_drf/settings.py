...
SECRET_KEY = 'django-insecure-z&i064^s$(frb9qoxxyfvp(*b(am#2xmc*%9m=hik4qur#hvh0'
...
BASE_URL = os.environ.get('MY_APP_BASE_URL', 'http://localhost:8000')
API_URL = f'{BASE_URL}/api/task-list/'
